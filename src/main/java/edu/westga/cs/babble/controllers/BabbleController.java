...
public class BabbleController {
    ...
    @FXML private TextField yourWordTextField;
    ...
    private void refreshTiles() {
        // Logic to refresh the tiles. For simplicity, this example only tries to draw a new tile
        // You can expand on this to draw multiple tiles or implement your desired behavior
        try {
